...
import img1 from "../../assets/pride/BlogSection/img1.png"; // Replace with your actual image path
import img2 from "../../assets/pride/BlogSection/img2.png"; // Replace with your actual image path
...
const BlogCard = () => {
  return (
    <div className="max-w-[980px] bg-white rounded-xl shadow-md p-6 mb-10  mx-auto space-y-4">
      {/* Title */}
      <h2 id="section-1"
       className="px-2 text-orange-500 px-4 text-2xl font-semibold">
