...
import img1 from "../../assets/pride/BlogSection/img7.png"; 
 

const BlogCard = () => {
  return (
    <div className="max-w-[980px] font-poppins text-justify bg-white rounded-xl shadow-md p-6 mb-10 max-w-3xl mx-auto space-y-4">
      {/* Title */}
      <h2 id="section-4" 
