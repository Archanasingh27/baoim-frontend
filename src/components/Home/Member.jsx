...
import Ayush from "../../assets/Home/TeamSection/1.png";
import Nakshatra from "../../assets/Home/TeamSection/Siddhart sir.png";
...
const TeamSection = () => {
  ...
  const members = [
    ...
    },
    {
      ...
      linkedin: "linkedin.com/in/bonnya-kar🏳️‍🌈🏳️‍⚧️-333274276",
      image: Bonnya,
    },
    {
      name: "Madhav Sharma",
